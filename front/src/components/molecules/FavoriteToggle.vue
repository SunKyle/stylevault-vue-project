<template>
  <div class="mb-6 p-6 bg-neutral-50 rounded-xl border border-neutral-200 flex items-center">
    <input
    ...
    >
      <font-awesome-icon v-if="localFavorite" :icon="['fas', 'heart']" class="text-white text-xs" />
    </div>
    <label
      for="favorite"
