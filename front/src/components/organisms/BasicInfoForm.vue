<template>
  ...
  <div class="space-y-8">
    <!-- 基本信息区域 -->
    <div
      class="mb-4 sm:mb-6 bg-neutral-50 rounded-xl p-4 sm:p-6 border border-neutral-200 shadow-sm hover:shadow-md transition-shadow"
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="form-group">
          ...
          <div class="select-container">
            <select v-model="form.category" :disabled="readOnly" class="form-control">
            ...
            <div class="select-arrow">
              <font-awesome-icon :icon="['fas', 'chevron-down']" class="select-arrow-icon" />
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="select-container">
            <select v-model="form.style" :disabled="readOnly" class="form-control">
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="form-group">
          ...
          <div class="select-container">
            <select v-model="form.color" :disabled="readOnly" class="form-control">
        ...
        <div class="form-group">
          ...
          <div class="select-container">
            <select v-model="form.material" :disabled="readOnly" class="form-control">
        ...
        <div class="form-group">
          ...
          <div class="select-container">
            <select v-model="form.size" :disabled="readOnly" class="form-control">
        ...
        <!-- 状况 -->
        <div class="form-group">
          <label class="form-label">状况</label>
          <div class="select-container">
            <select v-model="form.condition" :disabled="readOnly" class="form-control">
        ...
        <div class="form-group">
          <div class="relative">
            <textarea
              ...
              :placeholder="
                readOnly ? '' : '记录这件衣物的特殊信息，如：购买渠道、搭配建议、注意事项等...'
              "
            ></textarea>
...
<script setup>
  ...
  watch(
    () => form.value.price,
    newValue => validateField('price', newValue)
  );
  watch(
    () => form.value.notes,
    newValue => validateField('notes', newValue)
  );
