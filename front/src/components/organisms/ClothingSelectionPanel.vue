    ...
    <div class="card-content">
      ...
      <div class="cloth-list" v-if="safeFilteredClothes.length > 0">
        <div class="cloth-item-wrapper">
          <div v-for="item in safeFilteredClothes" :key="item.id" class="cloth-item-wrapper-item">
            <div class="cloth-item" :data-id="item.id">
              ...
              >
                ...
                <div class="img-wrapper">
                  <img :src="item.mainImageUrl" :alt="item.name" class="cloth-img" loading="lazy" />
                </div>
...
<script setup>
  ...
  // ===================== 通用方法 =====================
  // 判断衣物是否选中（封装重复逻辑）
  const isItemSelected = item => safeSelectedClothes.value.some(i => i.id === item.id);
